...
class __Mustache_19fab597f787085c88221787e1409213 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC2bf3508e4fa6f4dd1318958958d5eda($context, $indent, $value);
        $value = $context->find('hasblocks');
        $buffer .= $this->sectionD192047cae908bea39aba656223245cc($context, $indent, $value);
...
';
        ...
        $buffer .= $this->sectionE34d6b0df582977cedc04c8586b4d246($context, $indent, $value);
    ...
    private function sectionC2bf3508e4fa6f4dd1318958958d5eda(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
                    $context->pushBlockContext(array(
                        ...
                        'drawerheading' => array($this, 'blockE5c902c1e942952ab68675ef7e59944d'),
                        'drawercontent' => array($this, 'blockC9ab830f88783db67d555901f8dd8310'),
    ...
    private function sectionD192047cae908bea39aba656223245cc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionE34d6b0df582977cedc04c8586b4d246(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function blockE5c902c1e942952ab68675ef7e59944d($context)
    {
        $indent = $buffer = '';
        $buffer .= '            ';
        $value = $context->find('str');
...
';
    ...
    public function blockC9ab830f88783db67d555901f8dd8310($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . '            ';
