...
class __Mustache_6de4d9d84f98b4b2ff52b8148c3cdcb2 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        if ($partial = $this->mustache->loadPartial('theme_boost_magnific/header')) {
            $buffer .= $partial->renderInternal($context);
        }
...
';
        ...
        $buffer .= $this->section88771008b8c291075b227f2a6724e42a($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '
';
        $value = $context->find('frontpage_about_enable');
        $buffer .= $this->section6953cb2e1abfcda5e9dd535e1023b35a($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '
';
...
';
        ...
        $buffer .= $this->sectionAd75f690ce726011eac92744c5a42be5($context, $indent, $value);
...
';
    ...
    private function sectionFb86b74609cc8e0a9e8257c5b4b8465b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section88771008b8c291075b227f2a6724e42a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionFb86b74609cc8e0a9e8257c5b4b8465b($context, $indent, $value);
...
';
    ...
    private function sectionF2e73636588e197370b45bcc45126ff5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionF3202f10c7b2bce4df974a40a91bd950(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section2e9b37c9428cdbe4d7c19e5fb1637c78(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section6953cb2e1abfcda5e9dd535e1023b35a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionF2e73636588e197370b45bcc45126ff5($context, $indent, $value);
                $buffer .= $indent . '                    <h3>';
...
';
                ...
                $buffer .= $this->sectionF3202f10c7b2bce4df974a40a91bd950($context, $indent, $value);
                $buffer .= $indent . '                </div>
';
                $buffer .= $indent . '                <div class="frontpage_about_counterbox text-center">
';
                $value = $context->find('about_numbers');
                $buffer .= $this->section2e9b37c9428cdbe4d7c19e5fb1637c78($context, $indent, $value);
                $buffer .= $indent . '                </div>
';
                $buffer .= $indent . '            </div>
';
...
';
    ...
    private function sectionAd75f690ce726011eac92744c5a42be5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    require([ \'theme_boost_magnific/slideshow\'], function(slideshow) {
    slideshow.show();
    });
';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
...
';
                $buffer .= $indent . '    if ($(\'body\').hasClass(\'dir-rtl\') ) {
';
                $buffer .= $indent . '    var rtl = true;
';
                $buffer .= $indent . '    } else {
';
                $buffer .= $indent . '    var rtl = false;
';
                $buffer .= $indent . '    }
';
                $buffer .= $indent . '    });
';
                $buffer .= $indent . '    require([ \'theme_boost_magnific/slideshow\'], function(slideshow) {
';
