...
class __Mustache_feee93a82e1649b6a6840de329901b8e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC6fdb9b6eaec4ffa7a8be1b6bb7870bc($context, $indent, $value);
        $buffer .= $indent . '    </ol>
';
        $buffer .= $indent . '</nav>
';
    ...
    private function section48c8de084def7d67e1341aebacc1d362(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionC6fdb9b6eaec4ffa7a8be1b6bb7870bc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section48c8de084def7d67e1341aebacc1d362($context, $indent, $value);
                $value = $context->find('has_action');
                if (empty($value)) {
